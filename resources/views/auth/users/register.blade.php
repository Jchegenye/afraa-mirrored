...
<div class="row pt-5 pb-2 pl-5 pr-5 ">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group ml-3 shadow-xm">
                ...
                <input id="name" type="text"  placeholder="Full Name" class="form-control-lg rounded-0 form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
            ...
            <div class="form-group ml-3 shadow-xm">
                ...
                <input id="email" type="email" placeholder="Email" class="form-control-lg rounded-0 form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
            ...
            <div class="form-group ml-3 shadow-xm">
                ...
                <input id="password-confirm" type="password" placeholder="Confirm Password"  class="form-control-lg rounded-0 form-control" name="password_confirmation" required>
