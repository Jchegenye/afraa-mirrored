        ...
        <div class="col-md-11">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('dashboard/users/edit/' . $user->uid) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name'), $user->name }}" placeholder="{{$user->name}}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <select class="form-control" id="roleselector" name="roleselector">
                                        ...
                                        @php $single = ''; @endphp
                                            ...
                                            @foreach($allpermissions as $key => $roles)
                                                ...
                                                @if ($roles->role == $user->role )
                                                    <option value="{!! $user->role !!}" @if(old('roleselector') ==! $user->role) selected @endif> {{$user->role}}</option>
                                                @else
                                            ...
                                            <div id="{{$get_permissions->role}}" class="permissions active" style="display: block;"> 
                                                ...
                                                @foreach($get_allpermissions as $keys => $give_permissions)
                                                    ...
                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                        ...
                                                        <input type="checkbox" id="permissions{{$permKey1}}" name="permissions[]" class="custom-control-input" value="{{$give_permissions}}">
                                                ...
                                                @foreach($user->permissions as $keys => $permissions)
                                                    ...
                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                        <input type="checkbox" id="permissions{{$permKey2}}" name="permissions[]" class="custom-control-input" value="{{$permissions}}" checked>
                                            ...
                                            <div id="{{$get_permissions->role}}" class="permissions" style="display: none;"> 
                                                @foreach($get_allpermissions as $key => $give_permissions)
                                                    ...
                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                        ...
                                                        <input type="checkbox" id="permissions{{$key}}" name="permissions[]" class="custom-control-input" value="{{$give_permissions}}">
                                                        <label class="custom-control-label" for="permissions{{$key}}">
                                                            {{$give_permissions}}
                                                        </label>
